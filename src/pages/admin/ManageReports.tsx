...
const ManageReports = () => {
    ...
    return (
        <AdminLayout>
            <div className="flex flex-col gap-6 min-h-screen p-6 bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white">
                <h1 className="text-3xl font-bold text-blue-700 dark:text-white">Manage All Reports</h1>
                        ...
                        {reports.map((report) => (
                            ...
                            >
                                <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">
                                    {report.citizenName || 'Unknown User'}
                                </h2>
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="flex gap-2 overflow-x-auto">
                                        {report.photos.length > 0 ? (
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">No photos attached.</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <p className="mt-4 text-xs text-gray-400 dark:text-gray-500">
                                    Posted on {new Date(report.dateCreated).toLocaleString()}
                                </p>
                            </motion.div>
                        ))}
                    </div>
